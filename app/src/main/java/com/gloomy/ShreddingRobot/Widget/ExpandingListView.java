...
public class ExpandingListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter) {
        mAdapter = (CustomArrayAdapter) adapter;
...
//        Log.e(TAG, "listView expand");
        ...
        view.setBackgroundColor(getResources().getColor(R.color.history_selected_background));
...
//        Animation[] anims = new Animation[childCount];
//
//        for (int i = 0; i < childCount; i++){
//            anims[i] = AnimationUtils.loadAnimation(_context, R.anim.histo_item_enter_bottom);
//            anims[i].setStartOffset(50l * i);
//
//        }
//        for (int i = 0; i < childCount; i++) {
//            getChildAt(i).startAnimation(anims[i]);
//        }
//    }
